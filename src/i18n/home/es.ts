...
export const es: CopyHome = {
  ...
  planos: {
    ...
    leadBr: "Contactos y automatizaciones ilimitados. Instagram + TikTok en el mismo plan.",
    leadIntl: "Contactos y automatizaciones ilimitados. Instagram + TikTok en el mismo plan.",
    difEyebrow: "¿Por qué elegir Notifiquei?",
    difTitulo: "Más resultados. Menos complicación.",
    comparar: "Comparar todas las funciones",
    compararHref: "/es/vs-manychat",
    gratisChamada: "¿Todavía no quieres suscribirte?",
    notaAnual: "Paga menos\nen el plan anual",
    ciclo: "Ciclo de facturación",
    mensal: "Mensual",
    anual: "Anual",
    economia: "2 meses gratis",
    porMes: "/mes",
    cobradoAno: "se cobra {valor}/año en el plan anual",
    maisPopular: "Más popular",
    garantia: "Garantía de 7 días · devolución 100%",
    gratisTag: "Gratis para siempre",
    gratisNome: "Plan Gratis",
    gratisBlurb: "Empieza ahora y pruébalo sin compromiso.",
    gratisItens: [
    ...
    diferenciais: [
      ...
      { titulo: "Instagram y TikTok en el mismo plan", texto: "Una cuenta conecta los dos, sin plan aparte y sin pagar más por el segundo canal." },
