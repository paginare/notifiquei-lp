...
faq:
  - q: "Por que não devo mandar o preço logo que perguntam?"
    a: "Porque preço sem contexto vira objeção. Quando a pessoa ainda não tem clareza sobre por que deveria comprar de você, qualquer número parece caro. Entender o problema antes faz o preço chegar no momento certo, quando a cabeça dela já está no 'como eu compro'."
  - q: "Como qualificar um lead sem parecer um interrogatório?"
    a: "Faça uma pergunta por vez, espere a resposta e reaja ao que a pessoa falou antes de perguntar de novo. Em duas ou três trocas assim você já tem contexto suficiente, e a conversa parece uma troca humana, não um formulário de triagem."
  - q: "Qual a diferença entre um curioso e um comprador?"
    a: "O curioso fala sobre o produto ('vocês têm em azul?'), o comprador fala sobre o problema dele ('preciso resolver até sexta porque tenho um evento'). O curioso precisa ser nutrido com informação; o comprador precisa de menos atrito e um caminho direto pro sim."
---
...
[Veja como o Notifiquei pode qualificar seus leads no Instagram automaticamente →](https://notifiquei.com.br)
