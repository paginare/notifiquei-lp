...
// .wrangler/tmp/pages-gcqm5P/functionsWorker-0.8595781827647619.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var EURO = /* @__PURE__ */ new Set([
  "AT",
  "BE",
  "CY",
  "DE",
...
function decidir(pais, traduzida) {
  ...
  if (!pais || pais === "XX") return null;
  if (pais === "BR") return { market: "BR", currency: "BRL" };
  return { market: "INTL", currency: EURO.has(pais) ? "EUR" : "USD" };
}
__name(decidir, "decidir");
__name2(decidir, "decidir");
async function onRequest(context) {
  ...
  const saida = new HTMLRewriter().on("html", {
    element(el) {
...
// .wrangler/tmp/bundle-PHpetN/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-PHpetN/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8595781827647619.js.map
